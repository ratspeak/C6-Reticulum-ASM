...
- Active milestone is milestone 8 (LoRa SPI Interface); remaining blocker is physical SX1262 reset/readback. Wiring has been corrected to the Wio-SX1262 V1.0 header-carrier labels, but the current host session does not show an Espressif/Adafruit USB serial endpoint and `/dev/cu.debug-console` gives no ESP32-C6 ROM response.
