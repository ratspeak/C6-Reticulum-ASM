...
- Active milestone is milestone 8 (LoRa SPI Interface); eligible next claims are SPI foundation functions (`spi_init`, `spi_transfer`) followed by SX1262 command-driver slices.
