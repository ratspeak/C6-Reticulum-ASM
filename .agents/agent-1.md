...
milestone-5-path-table — claimed 2026-05-03T10:24:00Z, ETA active
...
- Active milestone is milestone 5; next eligible claims are `transport_path_init`, `transport_path_update`, `transport_path_lookup`, and `transport_process_announce`.
