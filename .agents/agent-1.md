...
- Active milestone is milestone 8 (LoRa SPI Interface); eligible next claims are `lora_interface_send`, `lora_interface_poll`, or the milestone-8 LoRa state model/hardware tests.
