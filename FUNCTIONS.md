...
- Tested (KAT-only, formal verifier pending): 4 (`sha256_init`, `sha256_compress`, `sha256_update`, `sha256_final` — milestone 2; full chain integration pending a sha256-test ELF)
- In progress: 0
