...
| `transport_path_response_cache_update` | ◉ verified |  | `transport_path_init` | 0001, 0002, 0004, 0005, 0006, 0009, 0011 | [minimal-transport-node](docs/milestones/milestone-10.md#path-response-handling) |
| `transport_path_response_send` | ◉ verified |  | `transport_path_lookup`, `lora_interface_send` | 0001, 0002, 0004, 0005, 0006, 0009, 0011 | [minimal-transport-node](docs/milestones/milestone-10.md#path-response-handling) |
| `transport_process_announce` | ◉ verified |  | `announce_validate`, `transport_path_update`, `transport_path_response_cache_update` | 0001, 0002, 0004, 0005, 0006, 0009 | [milestone-5](docs/milestones/milestone-5.md#transport_process_announce) |
| `transport_packet_seen` | ◉ verified |  | `packet_parse_header`, `sha256_init`, `sha256_update`, `sha256_final` | 0001, 0002, 0004, 0005, 0006, 0009, 0011 | [minimal-transport-node](docs/milestones/milestone-10.md#transport_packet_seen) |
| `transport_process_packet` | ◉ verified |  | `transport_packet_seen`, `packet_parse_header`, `transport_path_lookup`, `transport_path_response_send`, `transport_process_announce`, `link_process_packet`, `lora_interface_send` | 0001, 0002, 0004, 0005, 0006, 0009, 0011 | [minimal-transport-node](docs/milestones/milestone-10.md#transport_process_packet) |
...
| `lora_interface_poll` | ◉ verified |  | `lora_interface_init`, `sx1262_poll_receive`, `transport_process_packet` | 0001, 0002, 0003, 0005, 0006, 0009, 0011 | [milestone-8](docs/milestones/milestone-8.md#reticulum-interface-glue) |
...
| `lxmf_inbound_dispatch` | ◉ verified |  | `lxmf_message_parse`, `transport_path_lookup` | 0001, 0002, 0005, 0006, 0007, 0009 | [milestone-9](docs/milestones/milestone-9.md#inbound-delivery-dispatch) |
