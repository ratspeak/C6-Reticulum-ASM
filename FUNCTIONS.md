...
- Tested: 0
- In progress: 0
- Planned: 8 (`uart_isr` plus milestone-7 resource/channel functions:
  `channel_envelope_build`, `channel_envelope_parse`,
  `resource_advertisement_parse`, `resource_part_parse`,
  `resource_reassembly_init`, `resource_reassembly_update`, and
...
| Function | Status | Owner | Depends-on | ADRs | Spec |
|----------|--------|-------|-----------|------|------|
| `channel_envelope_build` | ☐ planned |  | `link_session_encrypt` | 0001, 0002, 0005, 0006, 0009 | [milestone-7](docs/milestones/milestone-7.md#channel-envelope) |
| `channel_envelope_parse` | ☐ planned |  | `link_session_decrypt` | 0001, 0002, 0005, 0006, 0009 | [milestone-7](docs/milestones/milestone-7.md#channel-envelope) |
| `resource_advertisement_parse` | ☐ planned |  | `channel_envelope_parse` | 0001, 0002, 0005, 0006, 0009 | [milestone-7](docs/milestones/milestone-7.md#resource-advertisement) |
| `resource_part_parse` | ☐ planned |  | `sha256_init`, `sha256_update`, `sha256_final` | 0001, 0002, 0005, 0006, 0009 | [milestone-7](docs/milestones/milestone-7.md#resource-parts) |
| `resource_reassembly_init` | ☐ planned |  | — | 0001, 0002, 0005, 0009 | [milestone-7](docs/milestones/milestone-7.md#reassembly-window) |
| `resource_reassembly_update` | ☐ planned |  | `resource_reassembly_init`, `resource_part_parse` | 0001, 0002, 0005, 0009 | [milestone-7](docs/milestones/milestone-7.md#reassembly-window) |
| `resource_process_plaintext` | ☐ planned |  | `channel_envelope_parse`, `resource_advertisement_parse`, `resource_part_parse`, `resource_reassembly_update` | 0001, 0002, 0004, 0005, 0006, 0009 | [milestone-7](docs/milestones/milestone-7.md#resource_process_plaintext) |
