...
| `transport_process_packet` | ◉ verified |  | `packet_parse_header`, `transport_process_announce`, `link_process_packet` | 0001, 0002, 0004, 0005, 0006, 0009, 0011 | [minimal-transport-node](docs/milestones/milestone-10.md#transport_process_packet) |
