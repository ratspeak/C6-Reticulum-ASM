...
- Tested: 0
- In progress: 0
- Planned: 10 (`uart_isr` plus the milestone-9 LXMF foundation functions)
...
| Function | Status | Owner | Depends-on | ADRs | Spec |
|----------|--------|-------|-----------|------|------|
| `lxmf_payload_build` | ☐ planned |  | `clock_now_ms` | 0001, 0002, 0005, 0006, 0007 | [milestone-9](docs/milestones/milestone-9.md#payload-codec) |
| `lxmf_payload_parse` | ☐ planned |  | — | 0001, 0002, 0005, 0006, 0007 | [milestone-9](docs/milestones/milestone-9.md#payload-codec) |
| `lxmf_message_id` | ☐ planned |  | `sha256_init`, `sha256_update`, `sha256_final`, `lxmf_payload_parse` | 0001, 0002, 0005, 0006, 0007, 0009 | [milestone-9](docs/milestones/milestone-9.md#message-id-and-signatures) |
| `lxmf_message_sign` | ☐ planned |  | `lxmf_payload_build`, `lxmf_message_id`, `identity_load`, `ed25519_sign` | 0001, 0002, 0005, 0006, 0007, 0009 | [milestone-9](docs/milestones/milestone-9.md#message-id-and-signatures) |
| `lxmf_message_verify` | ☐ planned |  | `lxmf_message_id`, `ed25519_verify` | 0001, 0002, 0005, 0006, 0007, 0009 | [milestone-9](docs/milestones/milestone-9.md#message-id-and-signatures) |
| `lxmf_message_pack` | ☐ planned |  | `lxmf_payload_build`, `lxmf_message_sign` | 0001, 0002, 0005, 0006, 0007, 0009 | [milestone-9](docs/milestones/milestone-9.md#message-envelope-codec) |
...
| `lxmf_delivery_announce_build` | ☐ planned |  | — | 0001, 0002, 0005, 0006, 0007 | [milestone-9](docs/milestones/milestone-9.md#delivery-announce-app-data) |
