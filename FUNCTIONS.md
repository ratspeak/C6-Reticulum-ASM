...
- Tested: 0
- In progress: 0
- Planned: 4 (`uart_isr` plus remaining milestone-7 resource functions:
  `resource_advertisement_parse`, `resource_reassembly_update`, and
